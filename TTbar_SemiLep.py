...
class TTbar_SemiLep(Module):
    ...
    def beginJob(self, histFile, histDirName):
        ...
        self.isttbar = False
        if ('TTJets_' or 'TT_Tune'or 'TTbar' ) in histFile :
           self.isttbar = True 
    ...
    def analyze(self, event):
        ...
        if isMC:
            ...
            # Not available in MINIAOD until 92X
            '''
            maxSubjetMass = 1.
        ...
        for ireco,reco in enumerate(recojets):
            if reco.subJetIdx1 > len(recosubjets) or reco.subJetIdx2 > len(recosubjets) : continue
        ...
        if self.verbose:
            print '----'
            print 'Hadronic Top/W candidate recojets:'
